  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex items-start justify-between">
        <div>
          <p className="text-sm font-medium text-slate-500">Strategy Score</p>
          ...
          <div className="mt-2 flex gap-2">
            ...
            {score.verified && (
              <span className="inline-flex items-center rounded border border-blue-200 bg-blue-50 px-2 py-0.5 text-xs text-blue-700">
                ✓ Verified
              </span>
            )}
