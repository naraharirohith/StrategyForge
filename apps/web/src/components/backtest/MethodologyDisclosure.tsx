...
export function MethodologyDisclosure({ dataSource = "Yahoo Finance", commissionPct = 0.1, slippagePct = 0.05, currency = "USD" }: Props) {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
      ...
      >
        <span className="text-sm font-medium text-slate-700">Backtest Methodology & Assumptions</span>
        <svg
      ...
      {open && (
        <div className="border-t border-slate-100 px-5 py-4 text-xs text-slate-600 space-y-3">
          ...
          <div>
            <p className="font-semibold text-slate-700 mb-1">Execution Model</p>
